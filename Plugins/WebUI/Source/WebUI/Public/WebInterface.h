...
public:
	...
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDragBeginSelfEvent, const FString&, URL);   //wqq 2021.1.8 
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDragProdToSceneEvent, const FString&, URL);   //wqq 2021.1.9
	...
	UPROPERTY(BlueprintAssignable, Category = "Web UI|Events")
	FOnDragBeginSelfEvent OnDragBeginSelfEvent;  //wqq 2021.1.8 ÍÏ×§ÊÂ¼þ

	UPROPERTY(BlueprintAssignable, Category = "Web UI|Events")
	FOnDragProdToSceneEvent OnDragProdToScene;  //wqq 2021.1.9 ÉäÏß¼ì²â 
...
private:
	...
	bool HandleDragBegin(FString dragData);  //wqq 2021.1.8 
	bool HandleDragProdToScene(FString dragData);  //wqq 2021.1.9
protected:
