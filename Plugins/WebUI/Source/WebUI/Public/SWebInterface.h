...
public:
		...
		, _ViewportSize( FVector2D::ZeroVector )
	{
		...
		SLATE_EVENT(FOnDragBeginSelfDelegate, OnDragBeginSelf)  //wqq 2021.1.8 拖拽事件
		SLATE_EVENT(FOnDragProdToSceneDelegate, OnDragProdToScene);  //wqq 2021.1.9 射线检测
...
protected:
	...
	FOnDragBeginSelfDelegate OnDragBeginSelf;  //wqq 2021.1.8 拖拽事件
	FOnDragProdToSceneDelegate OnDragProdToScene;  //wqq 2021.1.9 射线检测事件
