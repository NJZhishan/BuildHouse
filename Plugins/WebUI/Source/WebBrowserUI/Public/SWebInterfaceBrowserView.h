...
DECLARE_DELEGATE_RetVal_OneParam(bool, FOnDragBeginSelfDelegate, FString);  //wqq 2021.1.8 
DECLARE_DELEGATE_RetVal_OneParam(bool, FOnDragProdToSceneDelegate, FString);  //wqq 2021.1.9 
...
public:
	...
	{ }
		...
		SLATE_EVENT(FOnDragBeginSelfDelegate, OnDragBeginSelf)  //wqq 2021.1.8 
		SLATE_EVENT(FOnDragProdToSceneDelegate, OnDragProdToScene)  //wqq 2021.1.9 
...
private:
	...
	bool HandleDragBeginSelf(FString URL);  //wqq 2021.1.8 
	bool HandleDragProdToScene(FString URL);  //wqq 2021.1.9 
...
private:
	...
	FOnDragBeginSelfDelegate OnDragBeginSelf;   //wqq 2021.1.8 
	FOnDragProdToSceneDelegate OnDragProdToScene;   //wqq 2021.1.8 
