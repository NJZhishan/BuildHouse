...
void SWebInterface::Construct( const FArguments& InArgs )
{
	...
	[
		...
		.OnDragBeginSelf(this, &SWebInterface::HandleDragBeginSelf)  //wqq 2021.1.8 
		.OnDragProdToScene(this,&SWebInterface::HandleDragProdToScene)  //wqq 2021.1.9 
	];
}
...
//wqq 2021.1.8 
bool SWebInterface::HandleDragBeginSelf(FString URL)
{
#if UE_BUILD_DEVELOPMENT || UE_BUILD_DEBUG
	if (URL.StartsWith("chrome-devtools://"))
		return false;
...
//wqq 2021.1.9 
bool SWebInterface::HandleDragProdToScene(FString URL)
{
#if UE_BUILD_DEVELOPMENT || UE_BUILD_DEBUG
	if (URL.StartsWith("chrome-devtools://"))
		return false;
