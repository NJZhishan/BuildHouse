...
public:
	...
	virtual FOnDragBeginSelfDelegate& OnDragBeginSelf() override
	{
		return DragBeginSelfDelegate;  //wqq 2021.1.8 
	}

	virtual FOnDragProdToSceneDelegate& OnDragProdToScene() override
	{
...
private:
	...
	FOnDragBeginSelfDelegate DragBeginSelfDelegate;  //wqq 2021.1.8 
	FOnDragProdToSceneDelegate DragProdToSceneDelegate;  //wqq 2021.1.9 
